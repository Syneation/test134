...
<body>
    ...
    <figure style="display: flex;">
        <div class="text">
            <h1>Гостиная со вторым светом</h1>
        ...
        <div class="img1" >
            <img src="png/disain2.png" data-enlargeable style="cursor: zoom-in" alt="disain1" width="1100px">
            <img src="png/disain2(1).png" data-enlargeable style="cursor: zoom-in" alt="disain2" width="1100px">
            <img src="png/disain2(2).png" data-enlargeable style="cursor: zoom-in" alt="disain3" width="1100px">
        </div>
